...
urlpatterns = [
    ...
    path('mysky/mycommentdelete/', main.views.mycommentdelete, name="mycommentdelete"),
    path('mysky/mycommentedit/', main.views.mycommentedit, name="mycommentedit"),
    ...
    path('mysky/user_update/mycommentdelete/', main.views.mycommentdelete, name="mycommentdelete"),
    path('mysky/user_update/mycommentedit/', main.views.mycommentedit, name="mycommentedit"),
